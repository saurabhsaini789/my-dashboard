  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !localStorage.getItem(getPrefixedKey('goals_projects'))) {
      const SEED_PROJECTS: Project[] = [
        ...
        { id: crypto.randomUUID(), bucketId: 'Wealth', title: 'Savings Target - SEPT END', dueDate: '', isImportant: false, isCompleted: false, status: 'not-started', createdAt: new Date().toISOString(), tasks: [{ id: crypto.randomUUID(), title: 'Save aggressively and cut unnecessary expenses to reach ₹6-6.5 lakh by...', isCompleted: false }] },

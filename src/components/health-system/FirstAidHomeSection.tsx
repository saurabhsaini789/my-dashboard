    ...
    <section className="w-full">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 px-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button onClick={openAddModal} className="bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 text-xs font-bold px-6 h-[54px] rounded-2xl hover:scale-105 transition-all w-full md:w-auto">ADD ITEM</button>
        </div>
      </div>

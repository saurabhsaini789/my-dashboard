        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group">
            ...
            <input 
              ...
              className="bg-zinc-100 dark:bg-zinc-800 text-xs font-bold rounded-2xl h-[54px] pl-12 pr-4 border-none min-w-[200px] outline-none focus:ring-2 focus:ring-rose-600/20 transition-all"
            />
          </div>
